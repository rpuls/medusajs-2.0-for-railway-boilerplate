...
/**
 * Job that runs every minute to send scheduled notifications
 * 
 ...
 */
export default async function sendScheduledNotificationsJob(container: MedusaContainer) {
  const logger = container.resolve(ContainerRegistrationKeys.LOGGER)
  
  logger.info('Scheduled notifications job is currently disabled')
