...
export default async function RelatedProducts({
  ...
  return (
    <div>
      <h2 className="font-hanken text-2xl font-semibold text-kin-primary mb-12 uppercase tracking-wide">
        Sản phẩm liên quan
      </h2>

      <ul className="grid grid-cols-2 small:grid-cols-3 medium:grid-cols-4 gap-8">
