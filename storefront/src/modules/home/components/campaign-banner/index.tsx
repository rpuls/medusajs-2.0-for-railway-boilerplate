...
const CampaignBanner = () => {
  return (
    <section className="w-full bg-kin-forest text-white py-16 md:py-20">
      <div className="max-w-kin mx-auto px-5 md:px-12 text-center">
        <h2 className="font-hanken text-4xl md:text-5xl font-bold mb-6 tracking-tight leading-tight">
