  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black text-white font-sans">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-start pl-20 z-10">
        <h1 className="text-5xl font-[520] uppercase tracking-wide drop-shadow-md">
          GMORKL SPRING COLLECTION
        </h1>

        <Link
          href={`/${countryCode}/store`}
          className="mt-1.2 px-6 py-2 border border-white text-base font-semibold tracking-wide uppercase bg-white/10 hover:bg-white/20 transition-colors"
        >
