...
export const Divider = ({ orientation = "horizontal", variant = "solid", className, ...props }) => {
    return (React.createElement("div", { "aria-orientation": orientation, role: "separator", className: clx("border-ui-border-base", {
