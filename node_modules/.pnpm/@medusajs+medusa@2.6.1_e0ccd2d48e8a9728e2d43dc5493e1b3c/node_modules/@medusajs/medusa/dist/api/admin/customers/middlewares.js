...
exports.adminCustomerRoutesMiddlewares = [
    ...
    },
    {
        ...
        middlewares: [
            (0, framework_1.validateAndTransformQuery)(validators_1.AdminCustomerAddressParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["POST"],
        ...
        middlewares: [
            ...
            (0, framework_1.validateAndTransformQuery)(validators_1.AdminCustomerParams, QueryConfig.retrieveAddressTransformQueryConfig),
        ],
    },
    {
        method: ["DELETE"],
