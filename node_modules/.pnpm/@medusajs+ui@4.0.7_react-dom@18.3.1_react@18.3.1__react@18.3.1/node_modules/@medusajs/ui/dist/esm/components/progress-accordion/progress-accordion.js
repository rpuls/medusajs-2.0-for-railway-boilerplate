 ...
 */
const Root = (props) => {
    return React.createElement(RadixAccordion.Root, { ...props });
};
Root.displayName = "ProgressAccordion";
const Item = React.forwardRef(({ className, ...props }, ref) => {
    return (React.createElement(RadixAccordion.Item, { ref: ref, className: clx("border-ui-border-base border-b last-of-type:border-b-0", className), ...props }));
});
...
status = "not-started", children, ...props }, ref) => {
    return (React.createElement(RadixAccordion.Header, { ref: ref, className: clx("h3-core text-ui-fg-base group flex w-full flex-1 items-center gap-4 px-6", className), ...props },
        React.createElement(ProgressIndicator, { status: status }),
        children,
        React.createElement(RadixAccordion.Trigger, { asChild: true, className: "ml-auto" },
...
const Content = React.forwardRef(({ className, ...props }, ref) => {
    return (React.createElement(RadixAccordion.Content, { ref: ref, className: clx("overflow-hidden", "data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down pl-[88px] pr-6", className), ...props }));
});
