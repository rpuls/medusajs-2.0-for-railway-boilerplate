 ...
 */
const Root = (props) => {
    return React.createElement(RadixPopover.Root, { ...props });
};
Root.displayName = "Popover";
const Trigger = React.forwardRef((props, ref) => {
    return React.createElement(RadixPopover.Trigger, { ref: ref, ...props });
});
Trigger.displayName = "Popover.Trigger";
const Anchor = React.forwardRef((props, ref) => {
    return React.createElement(RadixPopover.Anchor, { ref: ref, ...props });
});
Anchor.displayName = "Popover.Anchor";
const Close = React.forwardRef((props, ref) => {
    return React.createElement(RadixPopover.Close, { ref: ref, ...props });
});
