...
const Cell = React.forwardRef(({ className, ...props }, ref) => (React.createElement("td", { ref: ref, className: (0, clx_1.clx)("h-12 py-0 pl-0 pr-6", className), ...props })));
Cell.displayName = "Table.Cell";
const Header = React.forwardRef(({ className, ...props }, ref) => (React.createElement("thead", { ref: ref, className: (0, clx_1.clx)("border-ui-border-base txt-compact-small-plus [&_tr]:bg-ui-bg-subtle [&_tr]:hover:bg-ui-bg-subtle border-y", className), ...props })));
Header.displayName = "Table.Header";
const HeaderCell = React.forwardRef(({ className, ...props }, ref) => (React.createElement("th", { ref: ref, className: (0, clx_1.clx)("txt-compact-small-plus h-12 py-0 pl-0 pr-6 text-left", className), ...props })));
